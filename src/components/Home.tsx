    ...
    <div className="relative max-w-[1320px] mx-auto min-w-[320px]">
      ...
      <div className="animate-fade-in">
        <img
          ...
          className={` ${!isDarkMode?'sm:w-36 md:w-44 lg:w-64 min-[320px]:w-36 absolute sm:top-12 right-0 animate-spin-slow sm:right-18':'sm:w-24 md:w-36 lg:w-48 min-[320px]:w-24 absolute sm:top-12 right-4 animate-spin-slow sm:right-18'} `}
        />
      </div>
      <img
        alt="laptop"
