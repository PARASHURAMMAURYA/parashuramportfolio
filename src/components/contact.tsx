...
const resetform =()=>{
  ...
  const sendEmail = () => {
    window.open(
      "https://mail.google.com/mail/u/0/#inbox?compose=lqrslrmLXbXlNkCnMdfpDgnlSXdfKkDkQgHGjTNgnVHKCVgBpSDcHNXdJZMmpsxhXcWfwGfgclBGMwllf"
    );
  };
  ...
  const submit = (e:any)=>{
    ...
    resetform()
    console.log(`hello ${name} your email is ${email} and Mo No is ${number} .`)
  }
  return (
    <>
      ...
      <ToastContainer />
        ...
        <section className="relative  z-10  text-white overflow-hidden py-20  lg:py-[120px]">
          <div className="container text-white ">
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  <span className="mb-4 block text-base font-bold text-blue-600">
                    Contact Us
                  </span>
...
"
                      className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-slate-200 dark:bg-primary/5 text-primary sm:h-[70px] sm:max-w-[70px]"
                    >
...
"
              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-5/12 ">
                <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-3 sm:p-12">
                  <form onSubmit={(e)=>submit(e)}>
                    ...
                    <TextareaAutosize
                      ...
                      name="details"
                      defaultValue=""
                      className="pb-3 text-black border border-black-2"
